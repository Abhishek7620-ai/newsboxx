       ...
       <?php include('../sidebar.php') ?>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
               ...
               {
                ?>
            <form class="user" action="edit-btn.php" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group" >
                                        <input type="text" class="form-control form-control-user" 
                                           name="Bdate" id="exampleInputPassword" placeholder="Birthdate" onfocus="(this.type='date')" value="<?php echo $row['date']; ?>" required>
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12 mb-3 mb-sm-0">
                                        <input type="text" class="form-control form-control-user"
                                           name="Password" id="exampleInputPassword" value="<?php echo $row['password']; ?>" placeholder="Password" required>
                                    </div>
                                 ...
                                 <a href="http://localhost/newsboxx/Admin/Employee_table.php"class="btn btn-danger btn-user  col-sm-3 mb-3 mb-sm-0">Cancel</a>
