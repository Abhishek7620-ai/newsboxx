            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                        <h2><i class="fa fa-laptop bg-orange"></i> Gadget's <small class="hidden-xs-down hidden-sm-down"> </small></h2>
                    </div><!-- end col -->
                    <div class="col-lg-4 col-md-4 col-sm-12 hidden-xs-down hidden-sm-down">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="tech-index.php">Home</a></li>
                            <li class="breadcrumb-item"><a href="shop.php">Shop</a></li>
                            <li class="breadcrumb-item active"> Gadget's </li>
                        </ol>
                    </div><!-- end col -->                    
                </div><!-- end row -->
            </div><!-- end container -->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                        ...
                        if(mysqli_num_rows($result1) > 0)
                        {
                          ...
                          if($page > 1){
                            echo '<li><a class="page-link" href="gadgets.php?page='.($page - 1).'">Prev</a></li>';
                          }
                          for($i = 1; $i <= $total_page; $i++)
                          {
                              ...
                              echo '<li class="page-item"><a class="page-link" href="gadgets.php?page='.$i.'">'.$i.'</a></li>';
                          }
                          if($total_page > $page){
                            echo '<li class="page-item"><a class="page-link" href="gadgets.php?page='.($page + 1).'">Next</a></li>';
                          }
                          echo '</ul>';
                          echo '</nav>';
                          echo '</div>
