                                ...
                                <div class="col-md-4">
                                    <div class="blog-box">
                                        ...
                                        <div class="blog-meta big-meta">
                                            ...
                                            <h4><a href="gadget-single.php?id=<?php echo $row['m_id']; ?>" title=""><?php echo $row['model'] ; ?></a></h4>
                                            ...
                                            <span class="input-group-btn">
                                              <button class="btn btn-default"><a href="<?php echo $row ['link']; ?> " target="_blank"><i class="fa fa-shopping-cart"> </i> Buy Now</a></button>
                                            </span>  
